import {LogonSearchRequest} from '../models/LogonSearchRequest';
import moment, {Moment} from 'moment';
import {isDateValid, partialDateRegex} from './Date';

export const atLeastOneFieldIsFilled = (fields: Partial<LogonSearchRequest>): string => {
...
export const startDateBeforeEndDate = (fields: Partial<LogonSearchRequest>): string => {
